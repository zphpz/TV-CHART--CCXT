/**
 * server.js — Lightweight Local HTTP Server & Polymarket API Proxy
...
const server = http.createServer((req, res) => {
  ...
  // Proxy Polymarket Crypto API endpoints
...
server.listen(PORT, () => {
  console.log(`[Server] TV-CHART--CCXT running at http://localhost:${PORT}`);
});
